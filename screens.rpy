    ...
    window background get_image("gui/settings/preferences_bg.jpg"):
        ...
        side "c b r":
            ...
            viewport id "preferences":
                ...
                has grid 1 23 xfill True spacing 15
                ...
                grid 3 1 xfill True:
                    ...
                    hbox xalign 0.5:
                        if _preferences.language == "spanish":
                            ...
                            null width 22
                        textbutton translation["Spanish"][_preferences.language] style "log_button" text_style "settings_text" action (SetField(config, "window_title", "Everlasting Summer"), SetField(persistent, "show_hentai_ach", False), Language("spanish"), Function(reload_names), Function(stop_music), Function(renpy.utter_restart))
...
init python:
    ...
    def sync_ach():
        for stm, game in achievments.iteritems():
            if game:
                achievement.grant(stm)
                ...
                button background None:
                    ...
                    if persistent.licensed:
                        if caption in persistent.choices and caption != "Налево" and caption != "Направо" and caption != "Go left" and caption != "Go right" and caption != "Ir a la izquierda" and caption != "Ir a la derecha":
                            text caption font "fonts/corbel.ttf" size 37 hover_size 37 color choice_colors_selected[persistent.timeofday] hover_color choice_colors_hover[persistent.timeofday] xcenter 0.5 text_align 0.5
                        else:
                            text caption font "fonts/corbel.ttf" size 37 hover_size 37 color choice_colors[persistent.timeofday] hover_color choice_colors_hover[persistent.timeofday] xcenter 0.5 text_align 0.5
                    else:
                        text caption font "fonts/corbel.ttf" size 37 hover_size 37 color choice_colors[persistent.timeofday] hover_color choice_colors_hover[persistent.timeofday] xalign 0.5
            else:
                if persistent.licensed:
                    text caption font "fonts/corbel.ttf" size 60 color choice_colors[persistent.timeofday] text_align 0.5 xcenter 0.5
                else:
                    text caption font "fonts/corbel.ttf" size 40 color choice_colors[persistent.timeofday] xalign 0.5 text_align 0.5 xcenter 0.5
